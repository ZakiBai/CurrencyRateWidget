...
struct CurrencyWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = CurrencyWidgetAttributes(name: "Me")
    static let contentState = CurrencyWidgetAttributes.ContentState(value: 3)
